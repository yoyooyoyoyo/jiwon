$(function(){
        ...
        $("#fullpage").fullpage({
            ...
            afterLoad:function(anchorLink, index, direction) {
                ...
                if(index==4) {
                    ...
                    $('.pc_intro_wrap .intro_right .skill__inner-bar').addClass('active');  
                    $(".pc_intro_wrap .intro_left").addClass("active");
                    $(".pc_edit_design .slide_wrap .left_box").removeClass("active");
                    $(".pc_edit_design .slide_wrap .right_box").removeClass("active");
                    $(".pc_web_port .slide_wrap .left_box .left_web").removeClass("active");
                    $(".pc_web_port .slide_wrap .explain").removeClass("active");
    ...
    }*/ // 컴퓨터버전메뉴로고 z-index문제로 pc,mo버전 2가지를 만들어 따로 코딩함
    $(".pc_menu p").click(function(){
        $("#sub_menu").show();
    })
    $(".mo_menu p").click(function(){
        $("#mo_sub_menu").show();
    })
